...
import { E as CloudUpload, F as Bell, S as Frame, T as FileArchive, h as LayoutDashboard, i as SquareKanban, l as PanelLeft, o as Search, p as LogOut, t as X, u as Palette, x as GalleryVerticalEnd } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/AppLayout-CCI_kPBB.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarHeader, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "gradient-primary flex size-9 shrink-0 items-center justify-center rounded-xl shadow-[var(--shadow-glow)]",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Palette, { className: "size-5 text-primary-foreground" })
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarFooter, {
				className: "gap-2 p-3",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "glass flex items-center gap-3 rounded-xl p-2",
					children: [
						...
						!collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: "Marina Rocha"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "truncate text-xs text-muted-foreground",
								children: "Artista / Freelancer"
							})]
						}),
...
var API_URL = "http://localhost:8080/api/v1/activity";
...
async function fetchActivityHeatmap() {
	...
	const response = await fetch(`${API_URL}/heatmap`, { headers: getAuthHeaders() });
	if (!response.ok) throw new Error("Não foi possível carregar o mapa de atividade.");
...
var FILES = [{
	name: "cidade_flutuante_v07.psd",
	size: "2.4 GB"
}, {
	name: "reliquiario_highpoly.blend",
	size: "860 MB"
}];
function UploadModal({ open, onOpenChange }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, { children: "Enviar arquivos pesados" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescription, { children: "Suporte a .psd, .blend, .ai e .exr com até 5 GB por arquivo." })] }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "dot-grid rounded-xl border border-dashed border-border p-8 text-center",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CloudUpload, { className: "mx-auto size-8 text-primary" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-3 text-sm font-medium",
							children: "Arraste os arquivos aqui"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-xs text-muted-foreground",
							children: "ou clique para selecionar do seu computador"
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: FILES.map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center gap-3",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileArchive, { className: "size-4 text-primary" }),
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: progress === 100 ? "Enviado" : `${progress}%`
							})
						]
					}, f.name))
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogFooter, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
					...
					children: uploading ? "Enviando..." : "Iniciar envio"
				})] })
			]
		})
	});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarProvider, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppSidebar, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				className: "glass sticky top-0 z-20 flex flex-wrap items-center gap-3 rounded-none border-x-0 border-t-0 px-4 py-3",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
						...
						className: "gradient-primary text-primary-foreground",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CloudUpload, { className: "size-4" }), "Enviar Arquivo"]
					})
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
				className: "fade-up flex-1 p-4 md:p-6",
				children
			})]
		})]
...
//#endregion
export { DialogFooter as a, Progress as c, DialogDescription as i, fetchActivityHeatmap as l, Dialog as n, DialogHeader as o, DialogContent as r, DialogTitle as s, AppLayout as t, logActivity as u };

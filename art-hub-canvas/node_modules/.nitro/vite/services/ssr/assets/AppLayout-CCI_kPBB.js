...
import { n as Button, r as cn, t as Input } from "./input-BZBVMCdW.js";
import * as React from "react";
import { useEffect, useState } from "react";
import { Link, useNavigate, useRouterState } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { Bell, FileArchive, Frame, GalleryVerticalEnd, KanbanSquare, LayoutDashboard, LogOut, Palette, PanelLeft, Search, UploadCloud, X } from "lucide-react";
...
function AppSidebar() {
	...
	return /* @__PURE__ */ jsxs(Sidebar, {
		...
		children: [
			/* @__PURE__ */ jsx(SidebarHeader, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(Palette, { className: "size-5 text-primary-foreground" })
			...
			/* @__PURE__ */ jsx(SidebarContent, { children: /* @__PURE__ */ jsxs(SidebarGroup, { children: [/* @__PURE__ */ jsx(SidebarGroupLabel, { children: "Navegação" }), /* @__PURE__ */ jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: items.map((item) => /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, {
				asChild: true,
				...
				children: /* @__PURE__ */ jsxs(Link, {
					...
					children: [/* @__PURE__ */ jsx(item.icon, { className: "size-4" }), /* @__PURE__ */ jsx("span", { children: item.title })]
				})
			}) }, item.url)) }) })] }) }),
...
//#endregion
//#region src/lib/activity-api.ts
...
//#endregion
//#region src/components/UploadModal.tsx
var FILES = [{
...
function UploadModal({ open, onOpenChange }) {
	...
	return /* @__PURE__ */ jsx(Dialog, {
		...
		children: /* @__PURE__ */ jsxs(DialogContent, {
			...
			children: [
				/* @__PURE__ */ jsxs(DialogHeader, { children: [/* @__PURE__ */ jsx(DialogTitle, { children: "Enviar arquivos pesados" }), /* @__PURE__ */ jsx(DialogDescription, { children: "Suporte a .psd, .blend, .ai e .exr com até 5 GB por arquivo." })] }),
				/* @__PURE__ */ jsxs("div", {
					className: "dot-grid rounded-xl border border-dashed border-border p-8 text-center",
					children: [
						/* @__PURE__ */ jsx(UploadCloud, { className: "mx-auto size-8 text-primary" }),
						/* @__PURE__ */ jsx("p", {
					...
					children: FILES.map((f) => /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								className: "flex items-center gap-3",
								children: [
									/* @__PURE__ */ jsx(FileArchive, { className: "size-4 text-primary" }),
									/* @__PURE__ */ jsx("span", {
...
function AppLayout({ title, subtitle, children }) {
	...
	return /* @__PURE__ */ jsxs(SidebarProvider, { children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("header", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs(Button, {
						...
						className: "gradient-primary text-primary-foreground",
						children: [/* @__PURE__ */ jsx(UploadCloud, { className: "size-4" }), "Enviar Arquivo"]
					})
				]
			}), /* @__PURE__ */ jsx("main", {
...
//#endregion
export { Dialog as a, DialogFooter as c, Progress as i, DialogHeader as l, fetchActivityHeatmap as n, DialogContent as o, logActivity as r, DialogDescription as s, AppLayout as t, DialogTitle as u };

...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        // Dados de teste: admin@atelie.com / Atelie123
        String adminEmail = "admin@atelie.com";
        String adminUsername = "admin";
        String defaultPassword = "Atelie123";
        ...
        try {
            ...
            userService.registerUser("Administrador do Ateliê", adminUsername, adminEmail, defaultPassword, Role.ARTIST);
            System.out.println("===================================================");
